...
public static partial class Constants
{
    ...
    public static readonly Regex RankOfDivineRegex = GenerateRankOfDivineRegex();
    public static readonly Regex DivineSuffixRegex = GenerateDivineSuffixRegex();
    ...
    [GeneratedRegex($@"\b({string.Join('|', KnownRanks)})\s+of\s+({string.Join('|', Divines)})\b", RegexOptions.IgnoreCase | RegexOptions.Compiled)]
    private static partial Regex GenerateRankOfDivineRegex();

    [GeneratedRegex($@"\bof\s+({string.Join('|', Divines)})\b", RegexOptions.IgnoreCase | RegexOptions.Compiled)]
    private static partial Regex GenerateDivineSuffixRegex();
